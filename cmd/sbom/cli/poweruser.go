...
import (
	...
	"github.com/nextlinux/sbom/cmd/sbom/cli/poweruser"
...
const powerUserExample = `  {{.appName}} {{.command}} <image>
  ...
  All behavior is controlled via application configuration and environment variables (see https://github.com/nextlinux/sbom#configuration)
`
