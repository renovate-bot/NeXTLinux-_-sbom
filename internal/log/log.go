/*
Package log contains the singleton object and helper functions for facilitating logging within the sbom library.
*/
package log
...
// Log is the singleton used to facilitate logging internally within sbom
