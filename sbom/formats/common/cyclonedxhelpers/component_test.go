...
func Test_encodeComponentProperties(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expected: &[]cyclonedx.Property{
				{Name: "sbom:package:foundBy", Value: "cataloger"},
				{Name: "sbom:location:0:path", Value: "test"},
				{Name: "sbom:metadata:gitCommitOfApkPort", Value: "97b1c2842faa3bfa30f5811ffbf16d5ff9f1a479"},
				{Name: "sbom:metadata:installedSize", Value: "4096"},
				{Name: "sbom:metadata:originPackage", Value: "libc-dev"},
				{Name: "sbom:metadata:provides:0", Value: "so:libc.so.1"},
				{Name: "sbom:metadata:pullChecksum", Value: "Q1p78yvTLG094tHE1+dToJGbmYzQE="},
				{Name: "sbom:metadata:pullDependencies:0", Value: "musl-utils"},
				{Name: "sbom:metadata:size", Value: "0"},
			},
		},
		{
			name: "from dpkg",
			...
			expected: &[]cyclonedx.Property{
				{Name: "sbom:package:metadataType", Value: "DpkgMetadata"},
				{Name: "sbom:metadata:installedSize", Value: "3036"},
				{Name: "sbom:metadata:source", Value: "tzdata-dev"},
				{Name: "sbom:metadata:sourceVersion", Value: "1.0"},
			},
		},
		{
			name: "from go bin",
			...
			expected: &[]cyclonedx.Property{
				{Name: "sbom:package:language", Value: pkg.Go.String()},
				{Name: "sbom:package:metadataType", Value: "GolangBinMetadata"},
				{Name: "sbom:package:type", Value: "go-module"},
				{Name: "sbom:metadata:architecture", Value: "amd64"},
				{Name: "sbom:metadata:goCompiledVersion", Value: "1.17"},
				{Name: "sbom:metadata:h1Digest", Value: "h1:KlOXYy8wQWTUJYFgkUI40Lzr06ofg5IRXUK5C7qZt1k="},
			},
		},
		{
			name: "from go mod",
			...
			expected: &[]cyclonedx.Property{
				{Name: "sbom:package:language", Value: pkg.Go.String()},
				{Name: "sbom:package:metadataType", Value: "GolangModMetadata"},
				{Name: "sbom:package:type", Value: "go-module"},
				{Name: "sbom:metadata:h1Digest", Value: "h1:KlOXYy8wQWTUJYFgkUI40Lzr06ofg5IRXUK5C7qZt1k="},
			},
		},
		{
			...
			expected: &[]cyclonedx.Property{
				{Name: "sbom:package:metadataType", Value: "RpmMetadata"},
				{Name: "sbom:package:type", Value: "rpm"},
				{Name: "sbom:metadata:epoch", Value: "2"},
				{Name: "sbom:metadata:release", Value: "1"},
				{Name: "sbom:metadata:size", Value: "12406784"},
				{Name: "sbom:metadata:sourceRpm", Value: "dive-0.9.2-1.src.rpm"},
			},
		},
	}
