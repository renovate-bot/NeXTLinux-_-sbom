...
func TestTosbomModel(t *testing.T) {
	sbom, err := TosbomModel(&spdx.Document{
		SPDXVersion:                "1",
		DataLicense:                "GPL",
...
func TestExtractSourceFromNamespaces(t *testing.T) {
	tests := []struct {
		...
		{
			namespace: "https://nextlinux.com/sbom/file/d42b01d0-7325-409b-b03f-74082935c4d3",
			expected:  source.FileScheme,
		},
		{
			namespace: "https://nextlinux.com/sbom/image/d42b01d0-7325-409b-b03f-74082935c4d3",
			expected:  source.ImageScheme,
		},
		{
			namespace: "https://nextlinux.com/sbom/dir/d42b01d0-7325-409b-b03f-74082935c4d3",
...
func Test_tosbomRelationships(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			actual := tosbomRelationships(tt.args.spdxIDMap, tt.args.doc)
