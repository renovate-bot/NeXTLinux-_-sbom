...
func ToFormatModel(s sbom.SBOM) model.Document {
	...
	if err != nil {
		log.Warnf("unable to create sbom-json source object: %+v", err)
	}
	...
	return model.Document{
		...
		Schema: model.Schema{
			...
			URL:     fmt.Sprintf("https://raw.githubusercontent.com/nextlinux/sbom/main/schema/json/schema-%s.json", internal.JSONSchemaVersion),
		},
	}
}
