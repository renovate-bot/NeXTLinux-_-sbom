...
func Test_tosbomSourceData(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			actual := tosbomSourceData(test.src)
...
func Test_idsHaveChanged(t *testing.T) {
	s, err := tosbomModel(model.Document{
		Source: model.Source{
			Type:   "file",
			Target: "some/path",
		},
...
func Test_tosbomFiles(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.want, tosbomFiles(tt.files))
		})
	}
}
