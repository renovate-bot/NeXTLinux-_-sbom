/*
Package sbom is a "one-stop-shop" for helper utilities for all major functionality provided by child packages of the sbom library.

Here is what the main execution path for sbom does:
...
// SetLogger sets the logger object used for all sbom logging calls.
func SetLogger(logger logger.Logger) {
	log.Log = logger
}

// SetBus sets the event bus for all sbom library bus publish events onto (in-library subscriptions are not allowed).
