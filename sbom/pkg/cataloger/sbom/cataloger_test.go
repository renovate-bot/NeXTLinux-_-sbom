	...
	expectedPkgs := []pkg.Package{
		{
			...
			Version:   "3.2.0-r23",
			Type:      "apk",
			Locations: source.NewLocationSet(source.NewLocation("sbom.sbom.json")),
