...
// that the format requires. For example, all sbomjson formatted documents have a schema section which should have
// "nextlinux/sbom" within the version --if this isn't found then the validator should raise an error. These active
