...
import (
	...
	sbomjsonModel "github.com/nextlinux/sbom/sbom/formats/sbomjson/model"
	"github.com/nextlinux/sbom/sbom/pkg"
)

/*
This method of creating the JSON schema only captures strongly typed fields for the purpose of integrations between sbom
...
func build() *jsonschema.Schema {
	...
	documentSchema := reflector.ReflectFromType(reflect.TypeOf(&sbomjsonModel.Document{}))
